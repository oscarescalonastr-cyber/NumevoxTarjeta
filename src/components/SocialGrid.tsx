...
export const SocialGrid: React.FC<SocialGridProps> = ({
  ...
  return (
    <div className="w-full px-5 flex flex-col items-center">
      {/* Messaging Section */}
      <section className="w-full flex flex-col items-center mb-12 animate-fade-in-up">
        ...
        <button
          ...
          className="w-full bg-[#1c1b1b] border border-[#4c4546] rounded-xl py-4 px-4 flex items-center gap-3 hover:border-[#E11D48] transition-colors group cursor-pointer"
        >
          <span
            className="material-symbols-outlined text-[#c6c6c7] group-hover:text-[#E11D48] transition-colors"
      ...
      <section className="w-full flex flex-col items-center mb-12 animate-fade-in-up">
          ...
          {socialLinks.map((link) => {
            ...
            return (
              <a
                ...
                className="w-10 h-10 rounded-[0.75rem] bg-[#1c1b1b] border border-[#4c4546] flex items-center justify-center text-white hover:text-[#E11D48] hover:border-[#E11D48] hover:bg-[#E11D48]/10 transition-all shadow-sm group cursor-pointer relative"
              >
                {renderIcon()}
              </a>
            );
        ...
        <button
          ...
          className="px-8 py-3 bg-[#E11D48] rounded-[0.75rem] font-bold text-sm text-white hover:bg-[#BE123C] transition-colors mb-4 animate-pulse-glow border border-[#E11D48] cursor-pointer"
        >
          Guárdame
        </button>
        ...
        <button
          ...
          className="p-2 rounded-[0.75rem] hover:bg-[#1c1b1b] transition-colors group cursor-pointer"
          title="Compartir"
        >
          <span className="material-symbols-outlined text-[#c6c6c7] group-hover:text-white transition-colors text-2xl">
            share
          </span>
        </button>
      </section>
